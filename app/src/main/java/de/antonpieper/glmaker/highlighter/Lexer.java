...
public class Lexer implements Iterable<Token> {
    public static class Diff {
        @NonNull
        private final List<Token> original;
        @NonNull
        private final List<Token> edited;
        private final int start;
        private final int deleteEnd;
        private final int insertEnd;
        ...
        @NonNull
        public List<Token> original() {
            return original;
        }

        @NonNull
        public List<Token> edited() {
            return edited;
        }
